...
> a site which is basically a mix of a blog and a portfolio

Here is the site where all parts of my life will merge, from my creations to my resume, my skills and all.
...
A preview of each pages staged below
...
* 0.0.1
  * Initialization : working tree with blank files and directories
  * Docs : writing the first words on that README

---

## Contributing 

I don't really know what to write under there, leave a mail to help me if u want : 
*yupi.contact.pro@gmail.com*
...
**yupicode**
> leave a mail with any contributions, I'll read everything

## Contacts

* Only my mail for now : *yupi.contact.pro@gmail.com*
